...
# =============================================================================
    ...
    def m_get_info_about_file_DE(self, s_DE_login, s_DE_pass, s_DE_IP_Adress, s_Path_Linux_DE, s_tmp_path, tmp_file):
        ...
        #sshpass -p 'Dwie54.Warki' ssh dl67ad7@10.187.182.78 'cd /net/fem/filer/polkowice/a0129_ID_BUZZ/60_berechnungen/k23/; find . -name "*fz"' > log_dzis.txt
        print(s_command)
        os.system(s_command)
...
# =============================================================================
    ...
    def m_create_config_file(self):
        ...
        config['Linux DE authorization']['login'] = 'dl67ad7'
        config['Linux DE authorization']['password'] = 'Dwie54Warki'
        config['Linux DE authorization']['IP'] = '10.187.182.78'
